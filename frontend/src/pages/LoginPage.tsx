...
export const LoginPage: React.FC = () => {
  ...
  const redirectAfterLogin = (authRes: any) => {
    ...
    else if (authRes.role === 'ROLE_ADMIN') navigate('/admin/dashboard');
    else if (!authRes.profileComplete) navigate('/complete-profile');
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-slate-50 flex items-center justify-center px-4 py-8">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-brand-300/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
      <div className="absolute top-[20%] right-[-10%] w-96 h-96 bg-amber-300/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000"></div>
      <div className="absolute bottom-[-10%] left-[20%] w-96 h-96 bg-emerald-300/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000"></div>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            Welcome back! Fresh homestyle dinner awaits.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="flex items-center my-6">
            ...
            <span className="px-4 text-xs font-bold text-slate-400 uppercase tracking-wider">or sign in with email</span>
            <div className="flex-1 border-t border-slate-200"></div>
          </div>
          ...
          >
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button type="button" onClick={handleForgotPassword} className="text-xs font-bold text-brand-600 hover:text-brand-700 hover:underline">Forgot Password?</button>
                  </div>
                  <div className="relative group">
                ...
                {resetMessage && <motion.div initial={{ opacity:0, y:-10 }} animate={{opacity:1,y:0}} className="p-3 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm font-semibold">{resetMessage}</motion.div>}
          ...
          <div className="pt-6 mt-6 border-t border-slate-100 text-center">
            <p className="text-sm text-slate-500 font-medium">
              ...
              <Link to="/register" className="font-bold text-brand-600 hover:text-brand-700 hover:underline transition-colors">Register here</Link>
            </p>
          </div>
        </motion.div>
