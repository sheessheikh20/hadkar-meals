...
export const SuperAdminDashboardPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 rounded-3xl p-6 text-white shadow-xl mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-black tracking-tight">Super Admin Developer Console</h1>
              <span className="px-2 py-0.5 rounded-full bg-indigo-500 text-white text-[10px] font-black uppercase tracking-wider">
                Developer Access
              </span>
            </div>
            <p className="text-xs text-indigo-200 mt-0.5">
              Manage master dishes catalog, service locations, client accounts, and database configurations.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <span>Switch to Client Operations View</span>
        </Link>
      </div>
